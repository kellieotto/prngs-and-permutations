...
The fact that a PRNG passes several tests for pseudorandomness does not guarantee that it is sufficicently pseudorandom for a given purpose.
Several notable PRNG failures have occurred in the past and continue to persist.
The issues range from subtle questions of theory to blatant programming errors.
