################################################################################
# SLURM Array Job 2
# SPRT of permutation derangements, MT, vary n,FYKD
################################################################################
...
def testSeed(ss, nn):
    ...
    return ["MT", "fykd", ss, nn, res['decision_upper'], res['LR_upper'][-1], res['steps_upper'],
...
with open('../rawdata/MT_derangements_fykd_findn.csv', 'at') as csv_file:
