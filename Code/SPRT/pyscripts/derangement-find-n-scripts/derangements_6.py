################################################################################
# SLURM Array Job 6
# SPRT of permutation derangements, SHA256, vary n, fykd
################################################################################
...
def testSeed(ss, nn):
    ...
    return ["SHA256", "fykd", ss, nn, res['decision_upper'], res['LR_upper'][-1], res['steps_upper'],
...
with open('../rawdata/SHA256_derangements_fykd_findn.csv', 'at') as csv_file:
