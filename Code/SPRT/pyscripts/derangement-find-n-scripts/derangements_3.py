################################################################################
# SLURM Array Job 3
# SPRT of permutation derangements, SD, vary n, permute_indices
################################################################################
...
# Parameters for the Super Duper LCG
    ...
    return ["SD", "permute_indices", ss, nn, res['decision_upper'], res['LR_upper'][-1], res['steps_upper'],
...
with open('../rawdata/SD_derangements_pi_findn.csv', 'at') as csv_file:
