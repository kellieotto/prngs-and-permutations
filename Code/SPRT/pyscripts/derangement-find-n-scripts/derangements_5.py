################################################################################
# SLURM Array Job 5
# SPRT of permutation derangements, SHA256, vary n, permute_indices
################################################################################
...
def testSeed(ss, nn):
    ...
    return ["SHA256", "permute_indices", ss, nn, res['decision_upper'], res['LR_upper'][-1], res['steps_upper'],
...
with open('../rawdata/SHA256_derangements_pi_findn.csv', 'at') as csv_file:
