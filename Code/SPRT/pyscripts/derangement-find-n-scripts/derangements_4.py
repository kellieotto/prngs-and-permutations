################################################################################
# SLURM Array Job 4
# SPRT of permutation derangements, SD, vary n, fykd
################################################################################
...
def testSeed(ss, nn):
    ...
    return ["SD", "fykd", ss, nn, res['decision_upper'], res['LR_upper'][-1], res['steps_upper'],
...
with open('../rawdata/SD_derangements_fykd_findn.csv', 'at') as csv_file:
