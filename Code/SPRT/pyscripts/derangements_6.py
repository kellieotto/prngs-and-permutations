################################################################################
# SLURM Array Job 6
# SPRT of permutation derangements, SHA256, n=100, fykd
################################################################################
...
def testSeed(ss):
    ...
    return ["SHA256", "fykd", ss, res['decision_upper'], res['LR_upper'][-1], res['steps_upper'],
...
with open('../rawdata/SHA256_derangements_fykd_n100.csv', 'at') as csv_file:
