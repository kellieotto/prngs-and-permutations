################################################################################
# SLURM Array Job 2
# Conditional SPRT of sample probabilities (multinomial equal p), MT, n=13, k=3, s = half of 13C3, sample_by_index
################################################################################
...
def testSeed(ss, n, k, s):
    ...
    unpack = ["MT", "sample_by_index", ss, n, k]
    for svalue in s:
...
with open('../rawdata/MT_multinomial_condit_sbi.csv', 'at') as csv_file:
