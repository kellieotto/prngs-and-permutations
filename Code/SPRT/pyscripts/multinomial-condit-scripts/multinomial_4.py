################################################################################
# SLURM Array Job 4
# Conditional SPRT of sample probabilities (multinomial equal p), SD, n=13, k=3, s = half of 13C3, sample_by_index
################################################################################
...
with open('../rawdata/SD_multinomial_condit_sbi.csv', 'at') as csv_file:
