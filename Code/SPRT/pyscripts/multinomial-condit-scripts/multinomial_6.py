################################################################################
# SLURM Array Job 6
# Conditional SPRT of sample probabilities (multinomial equal p), SHA256, n=13, k=3, s = half of 13C3, sample_by_index
################################################################################
...
def testSeed(ss, n, k, s):
    ...
    unpack = ["SHA256", "sample_by_index", ss, n, k]
    for svalue in s:
...
with open('../rawdata/SHA256_multinomial_condit_sbi.csv', 'at') as csv_file:
