################################################################################
# SLURM Array Job 5
# Conditional SPRT of sample probabilities (multinomial equal p), SHA256, n=13, k=3, s = half of 13C3, PIKK
################################################################################
...
with open('../rawdata/SHA256_multinomial_condit_PIKK.csv', 'at') as csv_file:
