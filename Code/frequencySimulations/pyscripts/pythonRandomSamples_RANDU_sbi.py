    ...
    for kk in k:
        ...
        for ss in seedvalues:
            ...
            for rr in range(len(reps)):
                uniqueSampleCounts = getEmpiricalDistr(lcg, sample_by_index, n=nn, k=kk, reps=rep_diffs[rr], uniqueSamples=uniqueSampleCounts)
                ...
                with open('../rawdata/US_RANDU_sbi.csv', 'at') as csv_file:
                    writer = csv.writer(csv_file)
                    writer.writerow([nn, kk, ss, reps[rr], "sample_by_index", "RANDU", 
