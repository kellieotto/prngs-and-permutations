# SLURM Array Job 1: MT, sample_by_index, n=13, k=10
...
def testSeed(ss, reps):
	...
	for rr in range(len(reps)):
		uniqueSampleCounts = getEmpiricalDistr(mt, sample_by_index, n=nn, k=kk, 
...
with open('../rawdata/MT_1000seeds_sbi_n13_k10.csv', 'at') as csv_file:
