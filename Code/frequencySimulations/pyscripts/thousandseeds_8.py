# SLURM Array Job 1: Super Duper, sample_by_index, n=13, k=10
...
def testSeed(ss, reps):
	...
	for rr in range(len(reps)):
		uniqueSampleCounts = getEmpiricalDistr(sdlcg, sample_by_index, n=nn, k=kk, 
...
with open('../rawdata/SD_1000seeds_sbi_n13_k10.csv', 'at') as csv_file:
